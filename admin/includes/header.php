...
if (isset($_SESSION['admin_login'])) {
  ...
  $data = mysqli_query($con, "SELECT * FROM mitra WHERE USERNAME_MITRA = '$username'");
  $data_admin = mysqli_fetch_assoc($data);

  $id_mitra = $data_admin['ID_MITRA'];
  $nama_admin = $data_admin['NAMA_MITRA'];
  $profil_admin = $data_admin['FOTO_PROFILE'];
}
?>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                  <a class="dropdown-item" href="master_admin_ubah.php?id_mitra=<?= $id_mitra ?>">
